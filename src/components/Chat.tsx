...
export function Chat() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full max-w-screen-lg mx-auto pt-4 sm:pt-6 lg:pt-8 gap-4 h-[85vh] px-4">
      {/* Coluna Esquerda */}
      ...
      {/* Coluna Direita */}
      <div className="w-full lg:w-[40%] flex flex-col h-full rounded-lg border border-purple-400/50 bg-gradient-to-b from-purple-500/10 to-cyan-400/10 shadow-[0_0_20px_-5px_rgba(156,39,255,0.3)]">
        <div className="flex flex-col h-full rounded-lg bg-stone-900/80 backdrop-blur-sm border border-purple-400/50 shadow-[0_0_20px_-5px_rgba(0,240,255,0.3)]">
          ...
          <div className="flex items-center justify-between rounded-t-lg p-4 border-b border-stone-800 bg-gradient-to-r from-purple-500/20 to-cyan-400/20">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-cyan-400">
                CHAT DA LIVE
              </h2>
            </div>
            <div className="flex items-center gap-3">
          ...
          {/* Rodapé do Chat - Versão Compacta */}
